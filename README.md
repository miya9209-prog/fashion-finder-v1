...
## Update 05
- Finder 큰 박스 내부 요소들이 아래로 밀려보이던 문제 수정
- Finder card를 flex column 구조로 바꾸고, LIVE 보드를 하단에 고정
- 상단 제목/검색창/예시 문구 간격을 전체적으로 위로 당겨 원본 시안에 가깝게 조정

## Update 06
- Finder 박스 안의 제목/검색창/예시문장 그룹을 약 21px(약 5~6mm 체감) 위로 이동
- FINDER LIVE 보드는 기존 하단 위치 유지
- '이렇게 찾아보세요' 예시문장은 링크를 완전히 제거하고 일반 텍스트 카드로 변경
- 파란색/밑줄/hover 링크 인상을 제거
